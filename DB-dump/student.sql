...
INSERT INTO `student` (`student_id`, `admission_date`, `gender`, `enrolled_status`, `first_name`, `middle_name`, `last_name`, `dob`, `address`, `contact`, `discription`) VALUES
	('sa', '2017-06-15', 'Male', 'Is Enrolled', 's', 's', 's', '2017-06-28', '', '', '');
